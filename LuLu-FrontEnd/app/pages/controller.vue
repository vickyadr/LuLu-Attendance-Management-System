                            ...
                            <div class="my-5">
                                <div class="relative">
                                    <div class="flex justify-between divide-purple-200 divide-solid outline-purple-400 text-gray-700 block w-full border-2 duration-500 focus:border-purple-500 border-purple-200 hover:border-purple-300 rounded-md text-sm shadow-sm bg-slate-50 peer">
                                        <button type="button" class="flex items-center px-2 border-r-2 rounded-2xl font-medium duration-500 hover:border-purple-300 hover:text-teal-700 hover:bg-teal-50" v-on:click="() => {device.timezone = check.inRange(device.timezone-1, -23, 23); view.setFocusId('tz'); }"><FontAwesome :icon="faMinus" class="h-2"/></button>
                                        ...
                                        <button type="button" class="flex items-center px-2 border-l-2 rounded-2xl font-medium duration-500 hover:border-purple-300 hover:text-teal-700 hover:bg-teal-50" v-on:click="() => {device.timezone = check.inRange(device.timezone+1, -23, 23); view.setFocusId('tz');}"><FontAwesome :icon="faPlus" class="h-2"/></button>
                                    </div>
