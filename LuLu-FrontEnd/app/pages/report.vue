...
async function getDataReport(ev){
    ...
    const start = ev.startTimestamp + tz
    const end = ev.endTimestamp +tz
    ...
    <div class="h-[90lvh] border-2 rounded-xl border-purple-100 shadow-sm">
        ...
        <div class="">
            <div class="flex justify-between items-center pr-5 pl-2">
                ...
                <SimpleDatePicker v-on:date-range-selected="getDataReport" :init-start-date="format.stamp_to_naive_date()" :init-end-date="format.stamp_to_naive_date()" />
